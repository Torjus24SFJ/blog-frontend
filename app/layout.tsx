    ...
    <html lang="en">
      <body className="">
        <header className="bg-neutral-300 w-screen h-20 flex flex-row justify-between p-6">
          <Link href="/">
          <IoIosArrowBack size={30} className="text-black hover:opacity-80 hover:scale-130 transform hover:delay-200 transition-transform duration-200 ease-in-out cursor-pointer" />
          </Link>
